...
void PlayerManager::drawArrow(const Window& window, const char& arrow, const int& row, int& column) const
{
...
void PlayerManager::drawPlayerCards(const Window& window, int& row) const
{
